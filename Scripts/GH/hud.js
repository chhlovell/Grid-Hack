	...
	var hud = (function(hud){
		...
		hud.setup = function(){
			...
			hud.d1 = new gh.Dice(
				...
				document.getElementById("d1").getContext("2d")
			);
			...
			hud.d2 = new gh.Dice(
				...
				document.getElementById("d2").getContext("2d")
			);
			...
			/**
			 * Set the board elements to visible
			 */
			setVisibility(document.getElementById("aaBorder"), "visible");
			var lowerHud = document.getElementById("lowerHud");
			setVisibility(lowerHud, "visible");
		...
		hud.setupInput = function(){
			document.getElementById("endTurn").onclick = hud.onEndTurn;
			var actionButtons = document.getElementsByClassName("actionButton");
			console.log(actionButtons);
			console.log("finished setupInput");
		};
